...
model:add(nn.SpatialFullConvolution(16, 2, 2, 2, 2, 2))
--model:add(nn.SpatialConvolution(#classes, 4, 21, 21,1,1,10,10))
--model:add(nn.SpatialBatchNormalization(4, 1e-3))
--model:add(nn.ReLU())
--model:add(nn.SpatialFullConvolution(4, #classes, 1, 1, 1, 1))
