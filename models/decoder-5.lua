...
model:add(bottleneck(64, 32, true, pooling_modules[2]))          -- 64x128
--model:add(bottleneck(64, 16))
model:add(nn.VolumetricFullConvolution(32, #classes, 2,2,2,2,2,2))
...
--for i = 1, #classes do
--      classWeights[i] = 1 / (torch.log(1.04 + normHist[2-i+1]))
--end
