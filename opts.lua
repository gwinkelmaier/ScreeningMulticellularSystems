...
function opts.parse(arg)
   ...
   --maxepoch              (default 2)           maximum number of training epochs
   ...
   --imHeight              (default 224)         image height  (360 cv/256 cs/256 su)
   --imWidth               (default 224)         image width   (480 cv/512 cs/328 su)
   --labelHeight           (default 224)          label height  (45  cv/32 cs/32 su)
   --labelWidth            (default 224)          label width   (60  cv/64 cs/41 su)
   ...
   --noConfusion           (default skip)
                           skip: skip confusion, all: test+train, tes : test only, error : test and train error
