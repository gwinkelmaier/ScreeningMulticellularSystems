...
--local trainFile = opt.datapath .. 'training-lists/train-region.txt'
--local testFile = opt.datapath .. 'training-lists/test-region.txt'
local trainFile = 'lists/train-region.txt'
local testFile = 'lists/test-region.txt'
